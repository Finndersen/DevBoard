...
class TestContextAssemblyService:
    ...
    def service(self, test_registry, mock_project_repo, mock_task_repo, mock_resource_repo):
        """Context assembly service with mocked repositories and test registry."""
        return ContextAssemblyService(
            project_repository=mock_project_repo,
            task_repository=mock_task_repo,
            resource_repository=mock_resource_repo,
            context_provider_registry_instance=test_registry,
        )
    ...
    async def test_get_project_context_on_demand_without_user_description(
        ...
        resource = result.on_demand_resources[0]
        assert resource.description == "Auto-generated description"  # Generated description used
