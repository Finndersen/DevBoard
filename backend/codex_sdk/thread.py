...
from .types import Input, ThreadError, ThreadEvent, ThreadItem, Usage
...
class Thread:
    ...
    def run_streamed(self, input: Input, turn_options: TurnOptions | None = None, **kwargs: object) -> StreamedTurn:
    ...
    def _run_streamed_internal(self, input: Input, turn_options: TurnOptions) -> Iterable[ThreadEvent]:
