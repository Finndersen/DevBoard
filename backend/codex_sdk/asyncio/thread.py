...
class AsyncThread:
    ...
    async def _run_streamed_internal(self, input: Input, turn_options: TurnOptions) -> AsyncIterator[ThreadEvent]:
    ...
    async def run(self, input: Input, turn_options: TurnOptions | None = None, **kwargs: object) -> Turn:
        if turn_options is not None and kwargs:
            raise ValueError("Provide either TurnOptions or keyword arguments, not both")
