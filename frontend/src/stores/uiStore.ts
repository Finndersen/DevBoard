...
export type ViewType = 'task' | 'project' | 'codebase' | 'settings' | 'home' | 'mcp-servers' | 'claude-code' | 'tasks-list' | 'projects-list' | 'codebases-list' | 'events-list' | 'background-agents-list' | 'background-agent-detail' | 'background-agent-edit' | 'background-agent-run'
