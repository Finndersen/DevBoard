...
export default function WorktreeSlotsTab({ codebaseId }: WorktreeSlotsTabProps) {
  ...
  const renderSlotCard = (slot: WorktreeSlot) => {
    ...
    return (
      <Card key={slot.id} className="border border-gray-200 dark:border-white/[0.08]">
      ...
      <div className="space-y-4">
        <Card>
          <div className="animate-pulse space-y-3">
            <div className="h-4 bg-gray-200 dark:bg-white/[0.06] rounded w-1/3"></div>
            <div className="h-3 bg-gray-200 dark:bg-white/[0.06] rounded w-1/2"></div>
          </div>
        </Card>
        <div className="space-y-4">
          {[1, 2].map((i) => (
            <Card key={i}>
              <div className="animate-pulse space-y-3">
                <div className="h-4 bg-gray-200 dark:bg-white/[0.06] rounded w-1/2"></div>
                <div className="h-8 bg-gray-200 dark:bg-white/[0.06] rounded"></div>
                <div className="h-3 bg-gray-200 dark:bg-white/[0.06] rounded w-3/4"></div>
              </div>
            </Card>
          ))}
        </div>
