...
function getStatusInfo(mergeableState: string | null, ciStatus: string | null): StatusInfo {
...
function StatusIndicator({ mergeableState, ciStatus }: { mergeableState: string | null; ciStatus: string | null }) {
