...
export default function RenderHtmlToolDisplay({ toolCall, toolResult }: CustomToolDisplayProps) {
  ...
  if (isRunning) {
    return (
      <div className="flex w-full min-w-0">
        <div className="rounded-lg border border-blue-600 bg-blue-50 dark:bg-blue-900/10 px-3 py-1.5 flex items-center gap-2 shadow-sm">
  ...
  if (isError) {
    return (
      <div className="flex w-full min-w-0">
        <div className="rounded-lg border border-red-600 bg-red-50 dark:bg-red-900/10 px-3 py-1.5 flex items-center gap-2 shadow-sm">
    ...
    <>
      <div className="flex w-full min-w-0">
        <button
          ...
          className="rounded-lg border border-purple-600 bg-purple-50 dark:bg-purple-900/10 px-3 py-1.5 flex items-center gap-2 shadow-sm hover:opacity-80 transition-opacity text-left"
        >
          <svg
