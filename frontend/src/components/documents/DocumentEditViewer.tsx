    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex space-x-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg">
          <button
            ...
            className={`px-3 py-2 text-sm font-medium rounded-md transition-colors ${
              viewMode === 'cards'
                ? 'bg-white dark:bg-white/[0.06] text-gray-900 dark:text-white shadow-sm'
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 space-x-2">
          <span><kbd className="px-1 py-0.5 bg-gray-200 dark:bg-white/[0.06] rounded text-xs">Alt+1,2</kbd> Switch views</span>
          <span><kbd className="px-1 py-0.5 bg-gray-200 dark:bg-white/[0.06] rounded text-xs">Alt+E</kbd> Expand</span>
          <span><kbd className="px-1 py-0.5 bg-gray-200 dark:bg-white/[0.06] rounded text-xs">Alt+C</kbd> Collapse</span>
        </div>
      </div>
