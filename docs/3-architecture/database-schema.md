...
- [Key Concepts](../1-overview/key-concepts.md): Domain model definitions
- [System Design](./system-design.md): Overall architecture
- [Backend Components](./backend/components.md): Repository implementations
- [Backend Patterns](./backend/patterns.md): SQLAlchemy usage patterns
- [Conversation System](../4-ai-agents/conversation-system.md): Event-based messaging
