...
- [Conversation System](./conversation-system.md): Event-based conversation architecture
- [Tools and Capabilities](./tools-and-capabilities.md): Available agent tools
- [Claude Code Integration](./claude-code-integration.md): Claude Code agent details
- [Configuration](./configuration.md): Agent engine and model configuration
- [Context Assembly](./context-assembly.md): Multi-source context gathering
